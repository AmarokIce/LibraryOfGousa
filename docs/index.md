...
灯塔的全称是 `中型二位元化次要时间与空间相对反向鲁米斯转化器`。
...
在米拉特尔建立了衔接时空之初，灯塔的扩散能力并不稳定。这个微小宇宙的外壳因为不稳定的鲁米斯扩散也变得不稳定，鲁米斯最稀薄的那一部分成为了外壳的弱点，孱虫便趁机入侵。  
孱虫战争因此打响。衔接时空内的大部分岛屿都参与了这场战争，一些小岛屿也不可避免的受到侵略。虽然米拉特尔所在的 D-100H 也受到侵略，但当地的战争策略总是保持为防御，同时也不断的调集其他岛屿上精通工程的人员参与灯塔改建计划。  
战争持续了数个月，得到了神学院特批的技术支持下，灯塔成功被改建为能够通过降低分发浓度换取均匀扩散的设计，宇宙的外壳得以修复，孱虫战争也就此结束。
